...
typedef struct {
	...
	int*	  implies_arr0;		// efficiency: what a power jump implies about a higher power jump; at val = 0
	cls_lst** implies_ctx0;		// context of implies array for accounting of each higher jump implication; at val = 0
